...
const blogsRepository = db => {
    ...
    const findAllRecents = async (info, args) => {
        ...
        const options: any = { attributes: fields, order: [['created_at', 'DESC']] }
    ...
    const findAllPaginated = async (info, args) => {
        ...
        const paginatedList = new PaginatedList('blogs', blogs, start, end, totalPages, paginator.getCurrentPage(), paginator.getLimitRows(), paginator.getMaxRows())
