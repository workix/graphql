 ...
 * @returns {*}
 */
export const batchInsert = async (tableName: string, popData: any[], connection: any) => {
...
export const insert = async (tableName: string, data: any, connection: any) => {
  let queryString = `INSERT INTO "{table}" ({keys}) VALUES {values} RETURNING *;`;
  let keys: any[] = [];
  let values: any[] = [];
  let dataValues = '';
...
export const update = async (tableName: string, data: any, connection: any) => {
  const { id } = data;
...
export const insertOrUpdate = async (tableName: string, data: any, connection: any) => {
  const { id } = data;
...
export const select = async (tableName: string, options: any, connection: any) => {
...
export const exclude = async (tableName: string, options: any, connection: any) => {
...
export default { batchInsert, insert, update, insertOrUpdate, select, exclude };
