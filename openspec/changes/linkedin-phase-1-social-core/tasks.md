...
- [ ] 1.1 Criar modelos Sequelize `ConnectionRequest`, `Connection`, `Follow` e suas migrations
...
- [ ] 2.1 Criar modelo Sequelize `UserProfile` e migration para a tabela `user_profiles`
