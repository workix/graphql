...
Define os requisitos de resolução em lote com DataLoader para mensagens diretas (remetente/destinatário), notificações de usuário e recomendações de perfil.
