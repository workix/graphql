...
- [ ] 4.1 Registrar cada gap crítico do CAPABILITIES.md como entrada em `KNOW_ISSUES.md` com contexto suficiente para reprodução futura
- [ ] 4.2 Decidir com o usuário a ordem de prioridade dos apps para a primeira suíte de E2E
- [ ] 4.3 Abrir um novo change OpenSpec por app/suíte de E2E (ex.: `e2e-suite-frontend-admin`, `e2e-suite-frontend-client`, `e2e-suite-android`) usando o CAPABILITIES.md como insumo de requirements
- [ ] 4.4 Validar pontos de baixa confiança sinalizados no CAPABILITIES.md (ex.: entry points não confirmados no Android) antes de escrever o teste correspondente
